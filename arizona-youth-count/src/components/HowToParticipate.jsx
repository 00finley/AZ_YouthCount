        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            <div className="bg-az-blue/5 rounded-2xl p-8 h-full flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 mb-6 font-medium">
                Prefer to stay digital? Connect with us via Zoom, Discord, or Phone at a time that works for you.
              </p>
              ...
              <motion.a
                ...
                className="mt-auto inline-flex items-center justify-center px-6 py-3 rounded-lg bg-az-blue text-white font-black uppercase tracking-wide shadow-lg"
                whileHover={{ 
                  backgroundColor: "#0097c7",
                  boxShadow: "0 10px 30px rgba(0, 178, 227, 0.3)"
                }}
                whileTap={{ scale: 0.98 }}
              >
                Go to Booking Page 
