        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            >
              ...
              <div className="flex flex-col gap-2 pl-4 border-l-4 border-az-blue">
                {[
                  { text: 'Share your story.', color: 'text-az-blue' },
                  { text: 'Get paid.', color: 'text-az-orange' },
                  { text: 'Make an impact.', color: 'text-white' }
                ].map((item, i) => (
                  <motion.p
                    key={item.text}
                    className={`text-2xl sm:text-3xl lg:text-4xl font-black uppercase tracking-wide ${item.color}`}
          ...
          >
            <div className="relative w-full max-w-lg">
              ...
              <div className="rounded-3xl overflow-hidden border-4 border-white/10 shadow-2xl relative z-10 aspect-[4/5]">
                <img
              ...
              >
                <div className="bg-white rounded-2xl p-6 shadow-2xl border-4 border-az-blue max-w-[280px] text-center relative overflow-hidden">
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-1">
                    ...
                    <h3 className="text-4xl font-black text-az-purple mb-0">${CONFIG.GIFT_CARD_AMOUNT}</h3>
                    <div className="text-lg font-black uppercase tracking-tight text-gray-800">Gift Card</div>
                    <p className="text-gray-500 font-bold text-sm mt-1">For your time & story</p>
                  </div>
                </div>
              </motion.div>
            </div>
