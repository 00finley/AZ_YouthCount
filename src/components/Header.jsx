        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            ...
            <motion.a 
              ...
              whileTap={{ scale: 0.98 }}
            >
              <div className="text-az-purple">
                <svg fill="currentColor" height="40" viewBox="0 0 100 100" width="40" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 10 L80 10 L80 90 L10 90 L10 35 Z" opacity="0.2"></path>
                  <path d="M25 15 L85 15 L85 95 L15 95 L15 40 Z"></path>
                </svg>
              </div>
              <h1 className="text-xl font-black tracking-tight text-gray-900 uppercase leading-none">
                Arizona<br /><span className="text-az-orange">Youth Count</span>
              </h1>
            </motion.a>
            ...
            {/* Mobile Menu Button */}
            <motion.button
              className="md:hidden text-gray-900 hover:text-az-orange p-2"
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              className="fixed top-20 left-0 right-0 bg-white z-50 md:hidden shadow-2xl"
